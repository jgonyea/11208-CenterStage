 ...
 */
@Config
public class CenterStageDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4.7, 0, 0.36);
    ...
    public CenterStageDrive(HardwareMap hardwareMap) {
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, "driveRL");
        ...
        setLocalizer(new CenterStageLocalizer(hardwareMap, this));
